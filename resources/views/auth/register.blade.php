                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12">
                                            <div class="form-group">
                                                <input name="name" value="{{ old('name') }}" type="text" required="" class="form-control" placeholder="Full name">
                                                @error('name')
                                        ...
                                        <div class="col-md-12 text-center">
                                            <button type="submit" class="site-button">Register <span></span></button>
                                        </div>
